...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ritik\\Lab in Psychology\\Psychopy Experiments\\Adaptive Staircase\\Adaptive Staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome to the Experiment!\n\nThis is an Adaptive Staircase Experiment. In this Experiment you will have to press the 'left key' if you feel that the stimulus is tilted in the left direction or the 'right key' if you feel that the stimulus is tilted in the right direction.",
        font='Arial',
    ...
    for thisStaircase in staircase:
        ...
        thisExp.addData('corr_Ans',correct_resp)
