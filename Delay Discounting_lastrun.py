...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ritik\\Lab in Psychology\\Psychopy Experiments\\Delay Discounting\\Delay Discounting_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text="Welcome to a delay discounting experiment!\n\nIn this experiment you will be presented with two monetary values and you will have to make a decision regarding them. If you choose today please press 't' but if you choose later please press 'l'.",
        font='Arial',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Thank you for performing the experiment',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[polygon, text, key_resp],
        )
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['l','t'], ignoreKeys=["escape"], waitRelease=False)
